...
export const AffiliateStore: React.FC = () => {
  ...
  const validate = () => {
    const e: Record<string, string> = {};
    if (!newAffiliate.name.trim()) e.name = "Name required";
    if (!newAffiliate.description.trim()) e.description = "Description required";
    if (!newAffiliate.link.trim()) e.link = "Link required";
    try {
      if (newAffiliate.link) new URL(newAffiliate.link);
    } catch {
      e.link = "Enter valid URL";
    }
    setErrors(e);
    return Object.keys(e).length === 0;
  };
  ...
  const handleSubmit = async () => {
    ...
    try {
      const formData = new FormData();
      formData.append("name", newAffiliate.name);
      formData.append("description", newAffiliate.description);
      formData.append("link", newAffiliate.link);
      formData.append("section", newAffiliate.section);
      if (newAffiliate.imageFile) formData.append("image", newAffiliate.imageFile);
        ...
        <div className="admin-card">
          ...
          <div className="p-6 border-b border-border flex justify-between items-center">
            ...
            <button
              ...
              className="btn-primary flex items-center gap-2"
            >
              <PlusIcon className="h-4 w-4" /> Add Affiliate
            </button>
          </div>
        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50">
          <div className="bg-background rounded-lg p-6 w-full max-w-md mx-4">
            <div className="flex justify-between items-center mb-6">
              <h3 className="text-lg font-semibold">Add Affiliate</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <select
                  value={newAffiliate.section}
                  onChange={(e) =>
                    setNewAffiliate({ ...newAffiliate, section: e.target.value as StoreSection })
                  }
                  className="w-full p-3 border rounded-lg"
                >
                  <option value="shopping">Shopping</option>
              ...
              <div>
                ...
                <input
                  ...
                  onChange={(e) => setNewAffiliate({ ...newAffiliate, link: e.target.value })}
                  className="w-full p-3 border rounded-lg"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  accept="image/*"
                  onChange={(e) =>
                    setNewAffiliate({ ...newAffiliate, imageFile: e.target.files?.[0] || null })
                  }
