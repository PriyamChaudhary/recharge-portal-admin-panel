...
export const Login = () => {
  ...
  const handleLogin = async (e: React.FormEvent) => {
    ...
    try {
      const data = await adminService.login(formData.phone, formData.otp);
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pr-12 py-3 border border-border rounded-lg focus:ring-2 focus:ring-primary/20 focus:border-primary bg-card"
